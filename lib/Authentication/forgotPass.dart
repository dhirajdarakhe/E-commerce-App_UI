    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("We cannot find your email. Please enter the one which is linked to your account",style: GoogleFonts.montserrat(textStyle: TextStyle(color:Color(0xFFeb7777),fontWeight: FontWeight.w600,fontSize: m1*0.015)),),
                  SizedBox(height: m1*0.036,),
                  raisedButton("Submit", context, SignUp(true), m1, m2),
                  SizedBox(height: m1*0.016,),
          ...
          Text("1996-2020 BUYSY.com Inc.. or its affiliates",style: GoogleFonts.montserrat(textStyle: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: m2*0.03))),
