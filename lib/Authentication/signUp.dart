...
import 'package:internship_task/Authentication/forgotPass.dart';
import 'package:internship_task/Authentication/otpScreen.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Padding(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      !login ? Image.asset('assets/sel.png',height: m1*0.026,):
                      CircleAvatar(
                        radius: m1*0.013,
                      ...
                      Text("CREATE YOUR BUYSY PROFILE",style: GoogleFonts.montserrat(textStyle: TextStyle(color: login ? Color(0xFF979797):Color(0xFF181725),fontWeight: FontWeight.w500)),)
                    ],
                  ),
                  SizedBox(height: 15,),
                  Row(
            ...
            Text("1996-2020 BUYSY.com Inc.. or its affiliates",style: GoogleFonts.montserrat(textStyle: TextStyle(color: Color(0xFF979797),fontWeight: FontWeight.w500,fontSize: m2*0.03))),
      ...
      child: Form(
        child: Column(
          children: [
            ...
            Text("By clicking continue you agree to Buysy.com's",style: GoogleFonts.montserrat(textStyle: TextStyle(color: Color(0xFF979797),fontWeight: FontWeight.w600,fontSize: m2*0.03))),
            RichText(
              text: TextSpan(
            ...
            Hero(
                tag: "register",
                child: raisedButton("Get Started", context, homePage(), m1, m2)),
            ...
            child: Form(
              ...
              Column(
                children: [
                  ...
                  Hero(
                      tag: "otp",
                      child: raisedButton("Send OTP to mobile no.",context, otpScreen(), m1, m2)),
                  ...
                  Hero(
                      tag: "signIn",
                      child: raisedButton("Continue", context, otpScreen(), m1, m2)),
                  SizedBox(height: m1*0.05,),
